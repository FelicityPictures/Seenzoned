...
def get_sentence(markov):
    ...
    Returns:
        a sentence (string) generated by the markov dictionary
    ...
    while key[0][-1] in END_OF_SENTENCE_CHARS or key[1][-1] in END_OF_SENTENCE_CHARS: # makes sure it does not start at the end of a sentence
        key = list(choice(markov.keys()))
